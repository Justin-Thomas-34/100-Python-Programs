# Program 20: Python Program to Check Armstrong Number in an Interval
...
lower = int(input("Enter a number for lower limit of range: "))
upper = int(input("Enter a number for upper limit of range: "))
